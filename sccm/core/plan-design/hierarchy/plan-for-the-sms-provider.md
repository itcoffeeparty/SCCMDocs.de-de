...
> [!NOTE]  
>  Administratoren, die eine Configuration Manager-Remotekonsole verwenden, benötigen DCOM-Berechtigungen für eine Remoteaktivierung auf dem Standortservercomputer und dem SMS-Anbietercomputer. Diese Rechte können zwar jedem Benutzer und jeder Gruppe erteilt werden, es wird jedoch empfohlen, dass Sie sie der Gruppe „SMS-Administratoren“ erteilen, um die Verwaltung zu vereinfachen. Weitere Informationen finden Sie unter der [konfigurieren Sie DCOM-Berechtigungen für Configuration Manager-Remotekonsolen](../../../core/servers/manage/modify-your-infrastructure.md#BKMK_ConfigDCOMforRemoteConsole) im Abschnitt der [Ändern Ihrer System Center Configuration Manager-Infrastruktur](../../../core/servers/manage/modify-your-infrastructure.md) Thema.  
