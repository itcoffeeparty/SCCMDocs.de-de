---
title: Erstellen benutzerdefinierter Berichte | System Center Configuration Manager
...
---
# <a name="creating-custom-report-models-for-system-center-configuration-manager-in-sql-server-reporting-services"></a>Erstellen benutzerdefinierter Berichtsmodelle für System Center Configuration Manager in SQL Server Reporting Services
...
|Erstellen eines Berichtsmodellprojekts|Ein Berichtsmodellprojekt enthält die Definition der Datenquelle (eine DS-Datei), die Definition der Datenquellensicht (eine DSV-Datei) und das Berichtsmodell (eine SMDL-Datei).|Weitere Informationen finden Sie im Abschnitt [To create the report model project](#BKMK_CreateReportModelProject) in diesem Thema.|  
...
-   **V_GS_OPERATING_SYSTEM**: Enthält Informationen zu dem auf dem Clientcomputer installierten Betriebssystem.  
