...
|Ausführen der Ermittlung|Führen Sie die Ermittlung aus, um Ressourcen in Ihrem Netzwerk zu finden, z.B. Netzwerkinfrastruktur, Geräte und Benutzer.<br /><br /> Weitere Informationen finden Sie unter [Run discovery for System Center Configuration Manager](../../../../core/servers/deploy/configure/run-discovery.md).|  
