...
##  <a name="BKMK_Boundaries"></a> Standortgrenzen  
...
Wenn der Inhalt, der von einem Client angefordert wird, von einer gültigen Inhaltsquelle in einer aktuellen Begrenzungsgruppe nicht verfügbar ist, wartet der Client, bis der Fallback-Zeitraum für eine benachbarte Begrenzungsgruppe oder die standardmäßige Standortbegrenzungsgruppe erreicht wird, bevor der Client zusätzliche Inhaltsquellen suchen kann.

Wenn der Inhalt bei Bedarf verteilt wird, jedoch nicht verfügbar ist, wenn er von einem Client angefordert wird, beginnt der Prozess zum Übertragen des Inhalts zu einem Verteilungspunkt in der aktuellen Grenze.  
...
##  <a name="BKMK_BoundaryBestPractices"></a> Bewährte Methoden für Grenzen  
