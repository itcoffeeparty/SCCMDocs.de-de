...
-   Keine Unterstützung von Features der Vorabversion
...
-   [Welcher Branch von Configuration Manager soll verwendet werden?](which-branch-should-i-use.md): Informationen über die unterschiedlichen System Center Configuration Manager-Branches, damit Sie sicher sein können, dass Sie den besten Branch für Ihre Bedürfnisse installieren.

-   [Installieren und Upgraden mit dem Baselinemedium von Version 1606 für System Center Configuration Manager](install-the-ltsb.md): So installieren Sie einen neuen LTSB-Standort oder upgraden einen System Center 2012 Configuration Manager-Standort auf LTSB.

-   [Upgrade von Long-Term Servicing Branch auf Current Branch](convert-to-current-branch.md): So konvertieren Sie Ihre LTSB-Installation in eine Current Branch-Installation.

-   [Lizenzierung und Branches für System Center Configuration Manager](learn-more-editions.md): Informationen zur Software Assurance und zu verwandten Lizenzanforderungen für System Center Configuration Manager.
-   [Unterstützte Konfigurationen für LTBS (Long-Term Servicing Branch) von System Center Configuration Manager](supported-configurations-for-ltsb.md): Die Versionen und Anforderungen für das Betriebssystem und für abhängige Produkte wie z.B. SQL Server, die Sie mit LTSB verwenden können.
...
-   Um die Teile eines Themas zu identifizieren, die nicht für LTSB gelten, werden Features und Änderungen, die nach Version 1606 von Current Branch eingeführt wurden, mit einem Wortlaut wie etwa *Ab Version 1610* identifiziert. Da diese nach Version 1606 von Current Branch eingeführt wurden, sind sie für LTSB nicht verfügbar.

### <a name="similarities-between-the-current-branch-and-the-ltsb"></a>Ähnlichkeiten zwischen Current Branch und LTSB
Da LTSB auf Version 1606 von Current Branch basiert (mit einigen Ausnahmen wie z.B. Intune-Integration und cloudbezogenen Features), sind die meisten Tasks für die Planung der Bereitstellung sowie das Konfigurieren und Verwalten der beiden Branches identisch.
...
Um die Version Ihres Standorts zu überprüfen, wechseln Sie oben links in der Konsole, wo die **Standortversion** als **5.0.8412.1000** angezeigt wird, zu **Informationen zu System Center Configuration Manager**.
