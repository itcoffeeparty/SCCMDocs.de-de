...
### <a name="role-based-administration-security-scopes-for-migrated-data"></a>Rollenbasierte Verwaltungssicherheitsbereiche für migrierte Daten  
 ...
 Informieren Sie sich vor dem Einrichten eines Migrationsauftrags über die rollenbasierte Verwaltung in System Center Configuration Manager. Richten Sie ggf. mindestens einen Sicherheitsbereich für die zu migrierenden Daten ein, um zu steuern, wer Zugriff auf die migrierten Objekte in der Zielhierarchie hat.  

 Weitere Informationen zu Sicherheitsbereichen und zur rollenbasierten Verwaltung finden Sie unter [Grundlagen der rollenbasierten Verwaltung für System Center Configuration Manager](../../core/understand/fundamentals-of-role-based-administration.md).  
