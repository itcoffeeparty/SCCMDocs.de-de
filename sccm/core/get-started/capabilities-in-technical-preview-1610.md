...
1.  [Erstellen Sie eine Anwendung](https://docs.microsoft.com/sccm/apps/deploy-use/create-applications) in der Configuration Manager-Konsole, die eine Genehmigung benötigt, und stellen Sie sie bereit.
