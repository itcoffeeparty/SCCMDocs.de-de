...
Weitere Informationen finden Sie in den [Optionen für die Übermittlungsoptimierung](/windows/deployment/update/waas-delivery-optimization#group-id) unter dem Übermittlungsmodus **Gruppe**.
