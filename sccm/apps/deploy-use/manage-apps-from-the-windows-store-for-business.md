...
Configuration Manager unterstützt die Verwaltung von Apps aus dem Microsoft Store für Unternehmen sowohl auf Windows 10-Geräten, auf denen der Configuration Manager-Client ausgeführt wird, als auch auf Windows 10-Geräten, die bei Microsoft Intune registriert sind (sogenannte Mischkonfiguration). Configuration Manager bietet die folgenden Funktionen für Online- und Offline-Apps.
...
- PCs müssen mit dem Arbeitsplatz Azure Active Directory verknüpft sein und sich im gleichen AAD-Mandanten befinden, in dem Sie Microsoft Store für Unternehmen als Verwaltungstool registriert haben.
...
- Wenn die Installation erzwungen wird, entweder vom Benutzer, der die Anwendung installiert, von der Anwendung, die ihren Stichtag für die Installation erreicht, oder durch eine erneute Bewertung nach der Installation für erforderliche Bereitstellungen:
    ...
    - Der Status der Anwendung in der Configuration Manager-Konsole meldet den Fehler „Die Microsoft Store-App wurde auf dem Client-PC geöffnet und wartet auf den Abschluss der Installation durch den Benutzer“.
...
- Wenn Sie eine Gruppenrichtlinie bereitgestellt haben, die den Zugriff auf die Benutzerversion von Microsoft Store deaktiviert, funktionieren Bereitstellungen aus dem Microsoft Store für Unternehmen nicht, auch wenn der Microsoft Store für Unternehmen aktiviert ist.
...
4. Sobald Sie fertig sind, wird das von Ihnen konfigurierte Konto in der Liste **Microsoft Store für Unternehmen** der Configuration Manager-Konsole aufgeführt.
...
6. Überprüfen Sie die Seite **Informationen**, und schließen Sie alle zusätzlichen Schritte und Konfigurationen so wie angegeben ab. Diese Konfigurationen sind erforderlich, um den Dienst mit Configuration Manager zu verwenden. Beispielsweise um den Microsoft Store für Unternehmen zu konfigurieren:
    ...
    - In der Konsole des Microsoft Store für Unternehmen müssen Sie Configuration Manager als Speicherverwaltungstool angeben, Unterstützung für Offline-lizenzierte Apps aktivieren und anschließen mindestens eine App kaufen. 
...
## <a name="create-and-deploy-a-configuration-manager-application-from-a-microsoft-store-for-business-app"></a>Erstellen und Bereitstellen einer Configuration Manager-Anwendung aus einer App aus dem Microsoft Store für Unternehmen
...
Eine Configuration Manager-App wird erstellt, die eine App aus dem Microsoft Store für Unternehmen enthält. Sie können diese Anwendung wie jede andere Configuration Manager-Anwendung bereitstellen und überwachen.
...
Beachten Sie nach der Bereitstellung von Online-Apps, dass alle Updates für die jeweilige App direkt aus dem Microsoft Store stammen.

Wenn Sie Offline-Apps mit dem Configuration Manager-Client auf Windows 10-Geräten bereitstellen (insbesondere in Mehrbenutzerumgebungen wie Schulungsräumen), deaktivieren Sie den Microsoft Store und/oder Anwendungsupdates über den Microsoft Store (z. B. mithilfe von [Gruppenrichtlinie](https://docs.microsoft.com/en-us/windows/configuration/stop-employees-from-using-microsoft-store#a-href-idblock-store-group-policyablock-microsoft-store-using-group-policy)), sodass Benutzer Anwendungen nicht außerhalb von Configuration Manager-Bereitstellungen aktualisieren können. Nachdem der Microsoft Store für Unternehmen-Administrator die App gekauft hat (und sie somit im Offlinezustand für die Synchronisierung mit Configuration Manager zur Verfügung stellt), veröffentlichen Sie die App für Benutzer nicht so, dass diese die App online installieren oder aktualisieren können. Dadurch wird sichergestellt, dass alle Benutzer App-Updates ausschließlich über Configuration Manager erhalten. 
