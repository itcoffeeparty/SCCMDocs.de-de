...
---
# <a name="how-to-create-configuration-items-for-windows-phone-devices-managed-with-intune"></a>Erstellen von Konfigurationselementen für Windows Phone-Geräte, die mit Intune verwaltet werden
